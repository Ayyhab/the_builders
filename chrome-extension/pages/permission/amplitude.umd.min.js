!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define("amplitude", t)
    : ((e =
        "undefined" != typeof globalThis ? globalThis : e || self).amplitude =
        t());
})(this, function () {
  "use strict";
  function e(e, t) {
  ...
  var d = "$default_instance",
    ...
    ne = {
      ...
      encode: function (e) {
        try {
          if (ie.btoa && ie.atob)
            return ie.btoa(unescape(encodeURIComponent(e)));
        } catch (e) {}
        return ne._encode(e);
      },
      _encode: function (e) {
      ...
      _decode: function (e) {
        ...
        for (e = e.replace(/[^A-Za-z0-9+/=]/g, ""); u < e.length; )
          (t =
            (ne._keyStr.indexOf(e.charAt(u++)) << 2) |
            ((r = ne._keyStr.indexOf(e.charAt(u++))) >> 4)),
            (i =
              ((15 & r) << 4) | ((o = ne._keyStr.indexOf(e.charAt(u++))) >> 2)),
  ...
  var se,
    ...
    he = function (e) {
      ...
      if (Object.keys(e).length > v)
        return (
          ce.error("Error: too many properties (more than 1000), ignoring"), {}
        );
      var i = {};
      for (var n in e)
    ...
    Te = function () {
      ...
      return (
        i && (e = parseInt(i, 32)),
        e || (ge.warn("unable to parse malformed cookie: ".concat(t)), 0)
      );
    },
    Pe = qe,
    Re = je,
    ...
    ze = function () {
      ...
      try {
        ...
        qe(t, n, e),
          ge.info("Testing if cookies available"),
          (i = je(t + "=") === n);
      } catch (e) {
        ge.warn(
    ...
    $e = function (e) {
      ...
      return (
        Ke.domain &&
          (t =
            "." === Ke.domain.charAt(0) ? Ke.domain.substring(1) : Ke.domain),
        e + t
      );
    },
    Be = function (e) {
      ...
      Ze.addBehavior &&
        ...
        (se = {
          ...
          clear: function () {
            ...
            for (
              var e, t = 0;
              (e = Ze.XMLDocument.documentElement.attributes[t++]);
          ...
          return 0 === arguments.length
            ...
            : ((e = e || {}),
              ...
              (this._options.domain =
                e.domain ||
                this._options.domain ||
                (ie && ie.location && ie.location.hostname)),
    ...
    et = (function () {
      function e(t) {
        ...
        var l = Ce() ? Ce().href : void 0,
          p = r ? "" : Fe(l);
        if (((this.cookieDomain = o || (p ? "." + p : null)), Ye[c]))
          this.storage = c;
        else {
          var d =
            r ||
            ...
            value: function (e) {
              ...
              if (this.storage !== P) {
                ...
                switch (this.storage) {
                  case U:
                    ie.sessionStorage &&
                      ie.sessionStorage.setItem(this.storageKey, c);
                    break;
                  case R:
            ...
            value: function () {
              ...
              if ((e || (e = Xe.getItem(this.storageKey)), !e))
                try {
                  e =
                    ie.sessionStorage &&
                    ie.sessionStorage.getItem(this.storageKey);
                } catch (e) {
                  ge.info(
    ...
    !(function (t) {
      ...
      function u(e, t) {
        ...
        for (n = 0; n < e.length; n += 16)
          (u = d),
            ...
            (d = o(
              d,
              (h = r(h, f, v, d, e[n + 15], 22, 1236535329)),
              f,
              v,
              e[n + 1],
              5,
            ...
            (d = s(
              d,
              (h = o(h, f, v, d, e[n + 12], 20, -1926607734)),
              f,
              v,
              e[n + 5],
              4,
      ...
      function f(e, t) {
        return (function (e, t) {
          ...
          return (
            (n = u(o.concat(l(t)), 512 + 8 * t.length)), c(u(s.concat(n), 640))
          );
        })(d(e), d(t));
      }
      function v(e, t, i) {
  ...
  function St(e, t) {
    ...
    const i = (function (e) {
        ...
        switch (e.arrayFormat) {
          ...
          case "separator":
            return (t, i, n) => {
              const r =
                  "string" == typeof i && i.includes(e.arrayFormatSeparator),
                o =
                  "string" == typeof i &&
                  !r &&
                  yt(i, e).includes(e.arrayFormatSeparator);
              i = o ? yt(i, e) : i;
              const s =
                r || o
    ...
    for (const [e, i] of Object.entries(n))
      if ("object" == typeof i && null !== i)
        for (const [e, n] of Object.entries(i)) i[e] = It(n, t);
      else n[e] = It(i, t);
    return !1 === t.sort
      ? n
      : (!0 === t.sort
  ...
  function xt(e, t) {
    ...
    const i = (i) =>
        (t.skipNull && ft(e[i])) || (t.skipEmptyString && "" === e[i]),
      n = (function (e) {
        switch (e.arrayFormat) {
          case "index":
            return (t) => (i, n) => {
  ...
  function Et(e, t) {
    ...
    if (e.fragmentIdentifier) {
      ...
      (n.hash = e.fragmentIdentifier),
        (r = t[bt] ? n.hash : `#${e.fragmentIdentifier}`);
    }
    return `${i}${n}${r}`;
  }
  function Nt(e, t, i) {
  ...
  (qt.prototype.setProductId = function (e) {
    return (
      "string" !== oe(e)
        ? ge.error(
            "Unsupported type for productId: " + oe(e) + ", expecting string"
          )
        : ye(e)
    ...
    (qt.prototype.setQuantity = function (e) {
      return (
        "number" !== oe(e)
          ? ge.error(
              "Unsupported type for quantity: " + oe(e) + ", expecting number"
            )
    ...
    (qt.prototype.setPrice = function (e) {
      return (
        "number" !== oe(e)
          ? ge.error(
              "Unsupported type for price: " + oe(e) + ", expecting number"
            )
          : (this._price = e),
        this
      );
    ...
    (qt.prototype._isValidRevenue = function () {
      return (
        "number" === oe(this._price) ||
        (ge.error("Invalid revenue, need to set price field"), !1)
      );
    }),
  ...
  !(function (e, t) {
    !(function (i, n) {
      var r = "function",
        ...
        W = function (e, t) {
          if ((typeof e === s && ((t = e), (e = n)), !(this instanceof W)))
            return new W(e, t).getResult();
          var r =
              e ||
              (typeof i !== o && i.navigator && i.navigator.userAgent
          ...
          return (
            ...
            (this.getDevice = function () {
              var e = {};
              return (
                (e[p] = n), (e[u] = n), (e[l] = n), B.call(e, r, f.device), e
              );
            }),
            ...
            (this.setUA = function (e) {
              return (
                (r = typeof e === a && e.length > 350 ? $(e, 350) : e), this
              );
            }),
            this.setUA(r),
            this
  ...
  var Pt = Tt,
    ...
    Kt = new ((function () {
      function e() {
        return (
          n(this, e),
          e.instance || ((this.ingestionEndpoint = g), (e.instance = this)),
          e.instance
        );
      }
      return (
  ...
  !(function (e, t) {
    !(function (i, n) {
      var r = "function",
        ...
        G = function (e, t) {
          if ((typeof e === s && ((t = e), (e = n)), !(this instanceof G)))
          ...
          return (
            ...
            (this.getDevice = function () {
              var e = {};
              return (
                (e[p] = n), (e[u] = n), (e[l] = n), $.call(e, r, f.device), e
              );
            }),
            (this.getEngine = function () {
              var e = {};
            ...
            (this.setUA = function (e) {
              return (
                (r = typeof e === a && e.length > 275 ? K(e, 275) : e), this
              );
            }),
            this.setUA(r),
            this
  ...
  var Bt = (function () {
    ...
    Jt = function (e, t) {
      ...
      for (
        var n = 0, r = ["string", "number", "boolean", "undefined"];
        n < r.length;
        n++
      ) {
        if (r[n] === i) return e === t;
        ...
        (e.getInstance = function (t) {
          return (
            ...
            Xt.analyticsConnectorInstances[t] ||
              (Xt.analyticsConnectorInstances[t] = new e()),
            Xt.analyticsConnectorInstances[t]
          );
        }),
        e
  ...
  (Yt.prototype.Identify = it),
    ...
    (Yt.prototype.init = function (e, t, i, n) {
      var r = this;
      if ("string" !== oe(e) || ye(e))
        ge.error("Invalid apiKey. Please re-initialize with a valid apiKey");
      else
        try {
          (this._connector = Qt.getInstance(this._instanceName)),
            ...
            this.options.serverZoneBasedApi &&
              (this.options.apiEndpoint = zt(this.options.serverZone)),
            this._refreshDynamicConfig(),
            (this.options.apiKey = e),
            (this._storageSuffix =
              "_" +
              e +
              (this._instanceName === d ? "" : "_" + this._instanceName)),
            ...
            (this.cookieStorage = new Qe().getStorage(
          ...
          if (this.options.deferInitialization && !a)
            return void this._deferInitialization(e, t, i, n);
            ...
            (function (e) {
              ...
              o &&
                ...
                r.options.saveEvents &&
                  (ei(r._unsentEvents), ei(r._unsentIdentifys)),
                (r._lastEventTime = n),
                oi(r),
                (r._pendingReadStorage = !1),
                r._sendEventsIfReady();
              for (var s = 0; s < r._onInitCallbacks.length; s++)
                r._onInitCallbacks[s](r);
              (r._onInitCallbacks = []),
                (r._isInitialized = !0),
                o && r._runNewSessionStartCallbacks();
            })(),
    ...
    (Yt.prototype.deleteLowerLevelDomainCookies = function () {
      ...
      if (t && we() && e !== t && new RegExp(t + "$").test(e)) {
        for (
          var i = e.split("."), n = t.split("."), r = i.length;
          r > n.length;
          --r
        ) {
  ...
  var ei = function (e) {
    for (var t = 0; t < e.length; t++) {
      var i = e[t].event.user_properties,
        ...
        r = e[t].event.groups;
      (e[t].event.user_properties = xe(i)),
        (e[t].event.event_properties = xe(n)),
        (e[t].event.groups = ke(r));
    }
  };
  Yt.prototype._trackParamsAndReferrer = function () {
    ...
    if (
      ...
      this.options.includeReferrer &&
        (i = this._saveReferrer(this._getReferrer())),
  ...
  var ti = function e(i, n) {
    if ("object" === oe(n)) {
      ...
      for (var a in n)
        r.has(a)
          ? (i[a] = t(t({}, i[a]), n[a]))
          : Object.prototype.hasOwnProperty.call(n, a) && s(a);
    }
  };
    ...
    (Yt.prototype._logEvent = function (e, i, n, r, o, s, a, u, c, l) {
      if ((ii(this), e))
        if (this.options.optOut)
          hi(u, c, 0, "No request sent", { reason: "optOut is set to true" });
        else
          try {
            var p;
            ...
            var _ = {
              ...
              device_manufacturer:
                (li(this, "device_manufacturer") && y) || null,
    ...
    (Yt.prototype.logEventWithTimestamp = function (e, t, i, n, r) {
      ...
      return this._shouldDeferCall()
        ...
        ? Se(e, "eventType", "string")
          ? ye(e)
            ? (hi(n, r, 0, "No request sent", { reason: "Missing eventType" }),
              -1)
    ...
    if (this._apiKeySet("logRevenueV2()"))
      if (
        ...
        if (e && e._isValidRevenue())
          return this.logEvent(D, e._toJSONObject());
      } else
        ge.error(
          "Invalid revenue input type. Expected Revenue object but saw " + oe(e)
        );
  }),
  ...
  (Yt.prototype.sendEvents = function () {
    if (this._apiKeySet("sendEvents()")) {
      if (this.options.optOut)
        ...
        var e =
            (this.options.forceHttps || "https:" === ie.location.protocol
              ? "https"
              : "http") +
            "://" +
  ...
  for (var gi in ((mi._q = bi._q || []), bi._iq))
    Object.prototype.hasOwnProperty.call(bi._iq, gi) &&
      (mi.getInstance(gi)._q = bi._iq[gi]._q || []);
